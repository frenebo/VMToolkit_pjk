...
{
  // Face class ===================================================== 
  HEHandle Face::he() { return _mesh.get_mesh_he(_he); }
  HECHandle Face::he() const { return _mesh.get_mesh_he(_he); }
  ...
  VertexCHandle HalfEdge::from() const { return _mesh.get_mesh_vertex(_from); }
  VertexCHandle HalfEdge::to() const { return _mesh.get_mesh_vertex(_to); }

  EdgeHandle HalfEdge::edge() { return _mesh.get_mesh_edge(_edge); }
  EdgeCHandle HalfEdge::edge() const { return _mesh.get_mesh_edge(_edge); }

  FaceHandle HalfEdge::face() { return _mesh.get_mesh_face(_face); }
  FaceCHandle HalfEdge::face() const { return _mesh.get_mesh_face(_face); }

  HEHandle HalfEdge::pair() { return _mesh.get_mesh_he(_pair); }
  ...
  HEHandle Vertex::he() { return _mesh.get_mesh_he(_he); }
  HECHandle Vertex::he() const { return _mesh.get_mesh_he(_he); }
  ...
  // Edge class ===========================================================
  HEHandle Edge::he() { return _mesh.get_mesh_he(_he); }
  HECHandle Edge::he() const { return _mesh.get_mesh_he(_he); }
}